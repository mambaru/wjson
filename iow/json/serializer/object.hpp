...
private:
  ...
  */
  ...
  P unserialize_member( T& t, P beg, P end, member_if<ML, MR, true>, bool& unserialized, json_error* e )
  {
    ...
    json_error ee;
    auto itr = this->unserialize_member(t, beg, end, MR(), unserialized, &ee);
    if ( !ee )
    {
  ...
  P unserialize_member( T& t, P beg, P end, member_if<ML, MR, false>, bool& unserialized, json_error* e )
  {
    static const char *snull = "null";
    json_error ee;
    auto itr = unserialize_member(t, beg, end, ML(), unserialized, &ee);
    if ( !ee )
    {
      typename MR::serializer()(MR().ref(t), snull, snull+4, 0);
      return itr;
...
private:
  ...
  P unserialize_member( T& t, P beg, P end, member_if<ML, MR, true>, json_error* e )
  {
    static const char *snull = "null";
    json_error ee;
    auto itr = unserialize_member(t, beg, end, MR(), &ee);
    if ( !ee )
    {
      typename ML::serializer()(ML().ref(t), snull, snull+4, 0);
      return itr;
  ...
  P unserialize_member( T& t, P beg, P end, member_if<ML, MR, false>, json_error* e )
  {
    static const char *snull = "null";
    json_error ee;
    auto itr = unserialize_member(t, beg, end, ML(), &ee);
    if ( !ee )
    {
      typename MR::serializer()(MR().ref(t), snull, snull+4, 0);
      return itr;
